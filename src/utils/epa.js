...
const m = 0.18; //Clutch Factor - basically matches you win that you shouldn't helps your epa more than matches you lose that you shouldn't. 0.25 is a reasonable default that seems to match observed data, but can be tweaked for more or less "clutch" emphasis.
